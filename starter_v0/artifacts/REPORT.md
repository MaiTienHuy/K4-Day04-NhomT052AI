...
Mỗi thành viên tự viết mục của mình. Bản dưới đây điền đủ 4 người từ artifact/commit trên repository; P2/P3/P4 có thể sửa và tự commit lại mục của mình.
...
- [x] C2 đủ 4 người; P1 commit trên nhánh `MaiTienHuy`
